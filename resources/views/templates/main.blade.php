...
<html lang="pt-br">
    <head>
        ...
        <title>Gestão IFPR - @yield('titulo')</title>
    ...
    <body>
            ...
            <div class="container-fluid">
                <a href="{{route('index')}}" class="navbar-brand ms-sm-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="currentColor" class="bi bi-clipboard2-pulse-fill" viewBox="0 0 16 16">
                        ...
                        <span class="ms-3 fs-5">Gestão IFPR</span>
                </a>
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item dropdown ps-2">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="{{route('jogadores.index')}}" class="dropdown-item">Jogadores</a></li>
        ...
        <nav class="navbar fixed-bottom navbar-dark bg-secondary">
            <div class="container-fluid">
                <span class="text-white fw-light">&copy; Ana Paula Marques - TADS21</span>
            </div>
        </nav>
    </body>
